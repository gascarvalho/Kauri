...
from .factorial_manifest import (
    ...
    FUTURE_TREE_PROPOSAL_DELIVERY_CONTRACT_V3,
    FROZEN_MANIFEST_ID,
    ...
    SOURCE_BOUND_PROPOSAL_WITNESS_CONTRACT_V2,
...
V32_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS = (
    EXCLUDED_COVERAGE_SMOKE_SLOT_ID,
    "slot-037-n31-f2-b04-00",
)
V33_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS = (
    EXCLUDED_COVERAGE_SMOKE_SLOT_ID,
    "slot-037-n31-f2-b04-00",
)
V34_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS = (
    EXCLUDED_COVERAGE_SMOKE_SLOT_ID,
    "slot-037-n31-f2-b04-00",
)
V35_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS = (
    EXCLUDED_COVERAGE_SMOKE_SLOT_ID,
    "slot-037-n31-f2-b04-00",
)
V36_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS = (
    EXCLUDED_COVERAGE_SMOKE_SLOT_ID,
    "slot-037-n31-f2-b04-00",
)
...
V38_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS = (
    EXCLUDED_COVERAGE_SMOKE_SLOT_ID,
    "slot-037-n31-f2-b04-00",
)
V39_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS = (
    EXCLUDED_COVERAGE_SMOKE_SLOT_ID,
    "slot-037-n31-f2-b04-00",
)
V40_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS = (
    EXCLUDED_COVERAGE_SMOKE_SLOT_ID,
    "slot-037-n31-f2-b04-00",
)
V41_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS = (
    EXCLUDED_COVERAGE_SMOKE_SLOT_ID,
    "slot-037-n31-f2-b04-00",
)
V42_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS = (
    EXCLUDED_COVERAGE_SMOKE_SLOT_ID,
    "slot-037-n31-f2-b04-00",
)
...
V44_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS = (
    EXCLUDED_COVERAGE_SMOKE_SLOT_ID,
    "slot-037-n31-f2-b04-00",
)
V45_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS = (
    EXCLUDED_COVERAGE_SMOKE_SLOT_ID,
    "slot-037-n31-f2-b04-00",
)
...
V32_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT = (
    "results/shape-placement-factorial-v32-coverage-smoke"
)
V33_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT = (
    "results/shape-placement-factorial-v33-coverage-smoke"
)
V34_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT = (
    "results/shape-placement-factorial-v34-coverage-smoke"
)
V35_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT = (
...
V38_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT = (
    "results/shape-placement-factorial-v38-coverage-smoke"
)
V39_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT = (
    "results/shape-placement-factorial-v39-coverage-smoke"
)
V40_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT = (
    "results/shape-placement-factorial-v40-coverage-smoke"
)
V41_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT = (
...
V44_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT = (
    "results/shape-placement-factorial-v44-coverage-smoke"
)
V45_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT = (
...
V45_SMOKE_RUNTIME_SHA256 = (
    "1233efc18d8c10e04e0d6e82a5ab9fdd85b8f87023d68f3202aa9fa526bf9dad"
)
V45_COVERAGE_SMOKE_RUNTIME_SHA256 = (
    "6d757b20042bd14d915f05f4eea2bc998655778bcb6b20ba2e934b9649e4f4f3"
)
FROZEN_RUNTIME_SHA256 = "0" * 64
FROZEN_SMOKE_RUNTIME_SHA256 = "0" * 64
FROZEN_COVERAGE_SMOKE_RUNTIME_SHA256 = "0" * 64
...
_TIERED_OMISSION_WINDOW_V2 = "tiered-responsive-omission-v2"
...
_V37_EXCLUDED_REPAIR_FAULT_WINDOW_DURATION_S = 330
_V40_EXCLUDED_REPAIR_FAULT_WINDOW_DURATION_S = 360
_V37_AGGREGATION_TIMEOUT_MS_PER_DEPTH = 125
...
_CYCLE1_SELECTION_NOT_BEFORE_OPTION = (
    "--cycle-1-selection-not-before-monotonic-ns"
)
_CYCLE1_SELECTION_NOT_BEFORE_TOKEN = (
    "{{cycle_1_selection_not_before_monotonic_ns}}"
)
_CYCLE1_INHERITED_WAIT_EXEMPT_ELIGIBILITY_GATE_OPTION = (
    "--cycle-1-inherited-wait-exempt-eligibility-gate"
)
_CYCLE1_RESPONSIVE_CROSS_COMMIT_RETENTION_READINESS_GATE_OPTION = (
    "--cycle-1-responsive-cross-commit-retention-readiness-gate"
)
_CYCLE1_RESPONSIVE_DEGRADED_ACTORS_OPTION = (
    "--cycle-1-responsive-degraded-actors"
)
_CYCLE1_RESPONSIVE_CROSS_COMMIT_RETENTION_ADMISSION_POLICY_OPTION = (
    "--cycle-1-responsive-cross-commit-retention-admission-policy"
)
_FACTORIAL_CAMPAIGN_RETENTION_SCOPE_V1 = "factorial_campaign_v1"
_ORDERED_S066_COVERAGE_RETENTION_SCOPE_V1 = "ordered_s066_coverage_v1"
_EXCLUDED_REPAIR_S037_RETENTION_SCOPE_V1 = "excluded_repair_s037_v1"
_AGGREGATE_RELAY_PER_ACTOR_ADMISSION_POLICY_V1 = (
...
_V40_RETENTION_CONFIG_KEY = "experiment-responsive-cross-commit-retention-v2"
_V40_RETENTION_CONFIG_LINE = f"{_V40_RETENTION_CONFIG_KEY} = true"
_EXCLUDED_REPAIR_FAULT_ACTIVE_PHASE_SCOPE_V1 = (
    "excluded-repair-fault-active-phase-scope-v1"
)
_EXCLUDED_REPAIR_SMOKE_SEMANTIC_DELTA_V1 = (
    "byzantine.window.duration_s:450->300"
)
_EXCLUDED_REPAIR_SMOKE_SEMANTIC_DELTA_V2 = (
    "byzantine.window.duration_s:450->330"
)
_EXCLUDED_REPAIR_SMOKE_SEMANTIC_DELTA_V3 = (
    "byzantine.window.duration_s:450->330;"
...
_EXCLUDED_REPAIR_SMOKE_SEMANTIC_DELTA_V5 = (
    _EXCLUDED_REPAIR_SMOKE_SEMANTIC_DELTA_V4
    + ";cycle1.selection.responsive_cross_commit_retention.actor_origin_fault_"
    "marker_window_binding:unset->materialized_slot_omission_window_id"
)
_V39_POST_FAULT_SELECTION_OBSERVATION_GRACE_S = 5
...
def _uses_future_tree_proposal_delivery_contract(
    ...
    expected_by_manifest = {
        ...
        V32_MANIFEST_ID: FUTURE_TREE_PROPOSAL_DELIVERY_CONTRACT_V2,
        V33_MANIFEST_ID: FUTURE_TREE_PROPOSAL_DELIVERY_CONTRACT_V2,
        ...
        V38_MANIFEST_ID: FUTURE_TREE_PROPOSAL_DELIVERY_CONTRACT_V2,
        V39_MANIFEST_ID: FUTURE_TREE_PROPOSAL_DELIVERY_CONTRACT_V2,
        ...
        V44_MANIFEST_ID: FUTURE_TREE_PROPOSAL_DELIVERY_CONTRACT_V2,
        V45_MANIFEST_ID: FUTURE_TREE_PROPOSAL_DELIVERY_CONTRACT_V2,
        FROZEN_MANIFEST_ID: FUTURE_TREE_PROPOSAL_DELIVERY_CONTRACT_V3,
    }
...
def _uses_source_bound_proposal_witness_contract(
    ...
    return _source_bound_proposal_witness_contract(manifest) is not None


def _source_bound_proposal_witness_contract(
    manifest: FrozenFactorialManifest,
) -> str | None:
    responsive = manifest.byzantine.responsive_degradation
    expected_by_manifest = {
        manifest_id: SOURCE_BOUND_PROPOSAL_WITNESS_CONTRACT_V1
        for manifest_id in {
            V20_MANIFEST_ID,
            V21_MANIFEST_ID,
            V22_MANIFEST_ID,
    ...
    expected_by_manifest[FROZEN_MANIFEST_ID] = (
        SOURCE_BOUND_PROPOSAL_WITNESS_CONTRACT_V2
    )
    expected = expected_by_manifest.get(manifest.manifest_id)
    if expected is None or responsive is None:
        return None
    if (
        getattr(
            responsive,
...
def _uses_verified_response_duplicate_delivery_contract(
    ...
    expected_by_manifest = {
        ...
        V32_MANIFEST_ID: VERIFIED_RESPONSE_DUPLICATE_DELIVERY_CONTRACT_V2,
        V33_MANIFEST_ID: VERIFIED_RESPONSE_DUPLICATE_DELIVERY_CONTRACT_V2,
        ...
        V38_MANIFEST_ID: VERIFIED_RESPONSE_DUPLICATE_DELIVERY_CONTRACT_V2,
        V39_MANIFEST_ID: VERIFIED_RESPONSE_DUPLICATE_DELIVERY_CONTRACT_V2,
        ...
        V44_MANIFEST_ID: VERIFIED_RESPONSE_DUPLICATE_DELIVERY_CONTRACT_V2,
        V45_MANIFEST_ID: VERIFIED_RESPONSE_DUPLICATE_DELIVERY_CONTRACT_V2,
...
def _uses_post_final_convergence_unmatched_commit_evidence_contract(
    manifest: FrozenFactorialManifest,
) -> bool:
    responsive = manifest.byzantine.responsive_degradation
    expected_by_manifest = {
...
def _frozen_artifact_identity(manifest_id: str) -> _FrozenArtifactIdentity:
    identities = {
        ...
        V32_MANIFEST_ID: _FrozenArtifactIdentity(
            manifest_id=V32_MANIFEST_ID,
            manifest_sha256=V32_MANIFEST_SHA256,
            plan_sha256=V32_PLAN_SHA256,
            runtime_sha256=V32_RUNTIME_SHA256,
            smoke_runtime_sha256=V32_SMOKE_RUNTIME_SHA256,
            coverage_smoke_runtime_sha256=(
                V32_COVERAGE_SMOKE_RUNTIME_SHA256
            ),
        ),
        V33_MANIFEST_ID: _FrozenArtifactIdentity(
            manifest_id=V33_MANIFEST_ID,
            manifest_sha256=V33_MANIFEST_SHA256,
            plan_sha256=V33_PLAN_SHA256,
            runtime_sha256=V33_RUNTIME_SHA256,
            smoke_runtime_sha256=V33_SMOKE_RUNTIME_SHA256,
            coverage_smoke_runtime_sha256=(
                V33_COVERAGE_SMOKE_RUNTIME_SHA256
            ),
        ),
        V34_MANIFEST_ID: _FrozenArtifactIdentity(
            manifest_id=V34_MANIFEST_ID,
            manifest_sha256=V34_MANIFEST_SHA256,
            plan_sha256=V34_PLAN_SHA256,
            runtime_sha256=V34_RUNTIME_SHA256,
            smoke_runtime_sha256=V34_SMOKE_RUNTIME_SHA256,
            coverage_smoke_runtime_sha256=(
                V34_COVERAGE_SMOKE_RUNTIME_SHA256
            ),
        ),
        V35_MANIFEST_ID: _FrozenArtifactIdentity(
            manifest_id=V35_MANIFEST_ID,
            manifest_sha256=V35_MANIFEST_SHA256,
            plan_sha256=V35_PLAN_SHA256,
            runtime_sha256=V35_RUNTIME_SHA256,
            smoke_runtime_sha256=V35_SMOKE_RUNTIME_SHA256,
            coverage_smoke_runtime_sha256=(
                V35_COVERAGE_SMOKE_RUNTIME_SHA256
            ),
        ),
        V36_MANIFEST_ID: _FrozenArtifactIdentity(
            manifest_id=V36_MANIFEST_ID,
            manifest_sha256=V36_MANIFEST_SHA256,
            plan_sha256=V36_PLAN_SHA256,
            runtime_sha256=V36_RUNTIME_SHA256,
        ...
        V38_MANIFEST_ID: _FrozenArtifactIdentity(
            manifest_id=V38_MANIFEST_ID,
            manifest_sha256=V38_MANIFEST_SHA256,
            plan_sha256=V38_PLAN_SHA256,
            runtime_sha256=V38_RUNTIME_SHA256,
            smoke_runtime_sha256=V38_SMOKE_RUNTIME_SHA256,
            coverage_smoke_runtime_sha256=(
                V38_COVERAGE_SMOKE_RUNTIME_SHA256
            ),
        ),
        V39_MANIFEST_ID: _FrozenArtifactIdentity(
            manifest_id=V39_MANIFEST_ID,
            manifest_sha256=V39_MANIFEST_SHA256,
            plan_sha256=V39_PLAN_SHA256,
            runtime_sha256=V39_RUNTIME_SHA256,
            smoke_runtime_sha256=V39_SMOKE_RUNTIME_SHA256,
            coverage_smoke_runtime_sha256=(
                V39_COVERAGE_SMOKE_RUNTIME_SHA256
            ),
        ),
        V40_MANIFEST_ID: _FrozenArtifactIdentity(
            manifest_id=V40_MANIFEST_ID,
            manifest_sha256=V40_MANIFEST_SHA256,
            plan_sha256=V40_PLAN_SHA256,
            runtime_sha256=V40_RUNTIME_SHA256,
            smoke_runtime_sha256=V40_SMOKE_RUNTIME_SHA256,
            coverage_smoke_runtime_sha256=(
                V40_COVERAGE_SMOKE_RUNTIME_SHA256
            ),
        ),
        V41_MANIFEST_ID: _FrozenArtifactIdentity(
            manifest_id=V41_MANIFEST_ID,
            manifest_sha256=V41_MANIFEST_SHA256,
            plan_sha256=V41_PLAN_SHA256,
            runtime_sha256=V41_RUNTIME_SHA256,
            smoke_runtime_sha256=V41_SMOKE_RUNTIME_SHA256,
            coverage_smoke_runtime_sha256=(
                V41_COVERAGE_SMOKE_RUNTIME_SHA256
            ),
        ),
        V42_MANIFEST_ID: _FrozenArtifactIdentity(
            manifest_id=V42_MANIFEST_ID,
            manifest_sha256=V42_MANIFEST_SHA256,
            plan_sha256=V42_PLAN_SHA256,
            runtime_sha256=V42_RUNTIME_SHA256,
        ...
        V44_MANIFEST_ID: _FrozenArtifactIdentity(
            manifest_id=V44_MANIFEST_ID,
            manifest_sha256=V44_MANIFEST_SHA256,
            plan_sha256=V44_PLAN_SHA256,
            runtime_sha256=V44_RUNTIME_SHA256,
            smoke_runtime_sha256=V44_SMOKE_RUNTIME_SHA256,
            coverage_smoke_runtime_sha256=(
                V44_COVERAGE_SMOKE_RUNTIME_SHA256
            ),
        ),
        V45_MANIFEST_ID: _FrozenArtifactIdentity(
            manifest_id=V45_MANIFEST_ID,
            manifest_sha256=V45_MANIFEST_SHA256,
            plan_sha256=V45_PLAN_SHA256,
            runtime_sha256=V45_RUNTIME_SHA256,
            smoke_runtime_sha256=V45_SMOKE_RUNTIME_SHA256,
            coverage_smoke_runtime_sha256=(
                V45_COVERAGE_SMOKE_RUNTIME_SHA256
            ),
        ),
...
class FaultContributionOpportunity:
    ...
    fault_mode: str
    authenticated_proposal_source_replica: int | None = None
...
class _EvidenceRecord:
    ...
    attempt_start_monotonic_ns: int | None = None
    reporter_local_commit_monotonic_ns: int | None = None
...
def _effective_omission_contract(
    ...
    window_suffix = {
        ...
        _TIERED_OMISSION_MODE_V2: _TIERED_OMISSION_WINDOW_V2,
...
def _coverage_smoke_slot_ids(manifest_id: str) -> tuple[str, ...]:
    ...
    if manifest_id == V45_MANIFEST_ID:
        return V45_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS
    if manifest_id == V44_MANIFEST_ID:
        return V44_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS
    ...
    if manifest_id == V41_MANIFEST_ID:
        return V41_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS
    if manifest_id == V40_MANIFEST_ID:
        return V40_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS
    if manifest_id == V38_MANIFEST_ID:
        return V38_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS
    if manifest_id == V39_MANIFEST_ID:
        return V39_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS
    ...
    if manifest_id == V35_MANIFEST_ID:
        return V35_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS
    if manifest_id == V34_MANIFEST_ID:
        return V34_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS
    if manifest_id == V33_MANIFEST_ID:
        return V33_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS
    if manifest_id == V32_MANIFEST_ID:
        return V32_EXCLUDED_COVERAGE_SMOKE_SLOT_IDS
...
def _coverage_smoke_result_root(manifest_id: str) -> str:
    ...
    if manifest_id == V32_MANIFEST_ID:
        return V32_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT
    if manifest_id == V33_MANIFEST_ID:
        return V33_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT
    if manifest_id == V34_MANIFEST_ID:
        return V34_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT
    if manifest_id == V35_MANIFEST_ID:
    ...
    if manifest_id == V38_MANIFEST_ID:
        return V38_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT
    if manifest_id == V39_MANIFEST_ID:
        return V39_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT
    if manifest_id == V40_MANIFEST_ID:
        return V40_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT
    if manifest_id == V41_MANIFEST_ID:
    ...
    if manifest_id == V44_MANIFEST_ID:
        return V44_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT
    if manifest_id == V45_MANIFEST_ID:
        return V45_EXCLUDED_COVERAGE_SMOKE_RESULT_ROOT
    if manifest_id == FROZEN_MANIFEST_ID:
...
def _validate_v33_static_timing_contract(
    manifest: FrozenFactorialManifest,
) -> None:
    """Pin the v33 deadline change without weakening its frozen schedule."""
    ...
    if (
        ...
        != _V33_TRANSITION_CONVERGENCE_DEADLINE_S
        or timers.leader_progress_timeout_ms
        != _V33_LEADER_PROGRESS_TIMEOUT_MS
        or manifest.byzantine.duration_s != _V27_FAULT_WINDOW_DURATION_S
        or timers.hard_timeout_s != _V27_HARD_TIMEOUT_S
    ):
        _fail(
            "v33 exact 30s convergence/20s leader/450s fault/650s hard "
    ...
    if (
        ...
        _fail("v37 exact 125ms aggregation-per-depth timing contract drifted")


def _expected_excluded_repair_observation_contract(
    manifest_id: str,
) -> str | None:
    if manifest_id in {
        V28_MANIFEST_ID,
        ...
        return EXCLUDED_REPAIR_SMOKE_OBSERVATION_CONTRACT_V1
    if manifest_id in {
        V34_MANIFEST_ID,
        V35_MANIFEST_ID,
        V36_MANIFEST_ID,
    ...
    if manifest_id == V39_MANIFEST_ID:
        return EXCLUDED_REPAIR_SMOKE_OBSERVATION_CONTRACT_V4
    if manifest_id == V40_MANIFEST_ID:
        return EXCLUDED_REPAIR_SMOKE_OBSERVATION_CONTRACT_V5
    if manifest_id in {
        V41_MANIFEST_ID,
        V42_MANIFEST_ID,
        V43_MANIFEST_ID,
...
def _excluded_repair_fault_window_duration_s(manifest_id: str) -> int | None:
    ...
    if manifest_id in {
        ...
        return _V28_EXCLUDED_REPAIR_FAULT_WINDOW_DURATION_S
    return None


def _uses_excluded_repair_observation(
    *,
    manifest_id: str,
    coverage_smoke: bool,
    slot_id: str,
) -> bool:
    """Dispatch the isolated repair chronology across its exact history."""
    ...
    return (
        ...
        and coverage_smoke
        and slot_id == _coverage_smoke_slot_ids(manifest_id)[1]
    )


def _uses_excluded_repair_cycle1_selection_gate(
    *,
    manifest_id: str,
    coverage_smoke: bool,
    slot_id: str,
) -> bool:
    """Scope the v39+ absolute selection gate to the repair smoke only."""
...
def _v34_excluded_repair_fault_active_phase_contract(
    *,
    manifest: FrozenFactorialManifest,
    expected: _ExpectedSlot,
    runtime: Mapping[str, Any],
    coverage_smoke: bool,
    validated_observation_contract: str | None,
) -> str | None:
    """Discriminate the authorized v34+ post-fault Epoch2 repair runtime."""
    ...
    if (
        ...
        or expected.slot_id != "slot-037-n31-f2-b04-00"
    ):
        return None
    responsive = manifest.byzantine.responsive_degradation
    manifest_contract = (
    ...
    causal_acceptance = _mapping(
        runtime.get("causal_acceptance"),
        "v34+ repair runtime causal acceptance",
    )
    fault_window = _mapping(
        runtime.get("fault_window"),
        "v34+ repair runtime fault window",
    )
    probe = _mapping(
        runtime.get("excluded_repair_smoke_probe"),
        "v34+ repair runtime probe",
    )
    expected_probe_fields = {
        "source_campaign_slot_id",
        "source_campaign_result_path",
        "source_campaign_artifact_id",
        "semantic_delta",
        "source_fault_window_duration_s",
    ...
    source_artifact_id = probe.get("source_campaign_artifact_id")
    expected_contract = _expected_excluded_repair_observation_contract(
        manifest.manifest_id
    )
    expected_duration_s = _excluded_repair_fault_window_duration_s(
        manifest.manifest_id
    )
    expected_semantic_delta = (
        ...
        in {
            ...
            if manifest.manifest_id == V40_MANIFEST_ID
                ...
                _EXCLUDED_REPAIR_SMOKE_SEMANTIC_DELTA_V3
                if manifest.manifest_id == V39_MANIFEST_ID
                else (
                    _EXCLUDED_REPAIR_SMOKE_SEMANTIC_DELTA_V2
                    if manifest.manifest_id
                    in {V37_MANIFEST_ID, V38_MANIFEST_ID}
                    else _EXCLUDED_REPAIR_SMOKE_SEMANTIC_DELTA_V1
                )
            )
        )
    )
    if not (
        expected.execution_ordinal == 5
        and expected.replica_count == 31
        and expected.f == 10
        and expected.q == 21
        and expected.block_id == "n31-f2-b04"
        and expected.arm_code == "00"
        and runtime.get("result_path")
        == f"{_coverage_smoke_result_root(manifest.manifest_id)}/{expected.slot_id}"
        and manifest_contract == expected_contract
        and validated_observation_contract == expected_contract
        and causal_acceptance.get(
            "excluded_repair_smoke_observation_contract"
        )
        == expected_contract
        and fault_window.get("duration_s") == expected_duration_s
        and fault_window.get("hard_timeout_s") == _V27_HARD_TIMEOUT_S
        and set(probe) == expected_probe_fields
        and probe.get("source_campaign_slot_id") == expected.slot_id
        and probe.get("source_campaign_result_path")
        == f"results/{manifest.manifest_id}/{expected.slot_id}"
        and isinstance(source_artifact_id, str)
        and re.fullmatch(r"slot-runtime-[0-9a-f]{24}", source_artifact_id)
        is not None
        and probe.get("semantic_delta") == expected_semantic_delta
        and probe.get("source_fault_window_duration_s")
        == _V27_FAULT_WINDOW_DURATION_S
        and probe.get("effective_fault_window_duration_s")
        == expected_duration_s
        and probe.get("hard_timeout_s") == _V27_HARD_TIMEOUT_S
        and probe.get("observation_contract") == expected_contract
        and probe.get("verified_response_duplicate_probe_contract")
        == EXCLUDED_REPAIR_SMOKE_VERIFIED_RESPONSE_DUPLICATE_PROBE_CONTRACT_V1
        and probe.get("verified_response_duplicate_probe_mode")
        == RESPONSE_DUPLICATE_PROBE_MODE_V1
        and (
            manifest.manifest_id
            not in {
            ...
            or (
                probe.get("post_fault_observation_grace_s")
                == _V39_POST_FAULT_SELECTION_OBSERVATION_GRACE_S
                and probe.get(
                    "cycle1_inherited_wait_exempt_eligibility_gate"
                )
                is True
                ...
                and tuple(
                    _integer(
                        actor,
                        "v40 canonical responsive-degraded actor",
                    )
                    for actor in _array(
                        probe.get("canonical_responsive_degraded_actor_ids"),
                        "v40 canonical responsive-degraded actors",
                    )
                )
                == _V40_RESPONSIVE_DEGRADED_ACTORS
                and probe.get(
                    "response_evidence_timeout_retention_schema_version"
                )
                == 2
        ...
        _fail("v34+ excluded repair fault-active phase scope binding drifted")
    return _EXCLUDED_REPAIR_FAULT_ACTIVE_PHASE_SCOPE_V1


def _v42_cycle1_retention_contract(
    runtime: Mapping[str, Any],
    *,
    expected: _ExpectedSlot,
    manifest: FrozenFactorialManifest,
    excluded_repair_runtime: bool,
) -> tuple[str, str, tuple[int, ...]] | None:
    """Independently bind the exact v42+ reporter-retention slot scope."""
    ...
    if expected.slot_id == EXCLUDED_SMOKE_SLOT_ID:
        if raw is not None:
            _fail("v42 reporter-retention contract escaped excluded N=7")
        return None

    result_path = _string(runtime.get("result_path"), "runtime result path")
    campaign_path = f"results/{manifest.manifest_id}/{expected.slot_id}"
    coverage_path = (
        f"{_coverage_smoke_result_root(manifest.manifest_id)}/{expected.slot_id}"
    )
    if result_path == campaign_path:
        expected_scope = _FACTORIAL_CAMPAIGN_RETENTION_SCOPE_V1
        expected_policy = _AGGREGATE_RELAY_PER_ACTOR_ADMISSION_POLICY_V1
    elif (
        result_path == coverage_path
        and expected.slot_id == EXCLUDED_COVERAGE_SMOKE_SLOT_ID
        and not excluded_repair_runtime
    ):
        expected_scope = _ORDERED_S066_COVERAGE_RETENTION_SCOPE_V1
        expected_policy = _AGGREGATE_RELAY_PER_ACTOR_ADMISSION_POLICY_V1
    elif (
        result_path == coverage_path
        and expected.slot_id == "slot-037-n31-f2-b04-00"
        and excluded_repair_runtime
    ):
        expected_scope = _EXCLUDED_REPAIR_S037_RETENTION_SCOPE_V1
        expected_policy = (
            _ONE_PER_ACTOR_WITH_GLOBAL_AGGREGATE_ADMISSION_POLICY_V1
        )
    else:
    ...
    v44_generic = (
        manifest.manifest_id
        in {V44_MANIFEST_ID, V45_MANIFEST_ID, FROZEN_MANIFEST_ID}
        and expected_scope
        in {
    ...
    actors = tuple(
        _integer(actor, "v42 reporter-retention actor", 0)
        for actor in _array(
            contract["responsive_degraded_actor_ids"],
            "v42 reporter-retention actors",
        )
    )
    expected_actors = tuple(expected.responsive_degraded_actor_ids)
    if (
        contract["scope"] != expected_scope
        or contract["observation_schema_version"] != 2
        or actors != expected_actors
...
def _validate_runtime_slot(
    ...
    _validate_v33_static_timing_contract(manifest)
    ...
    source_bound_proposal_witness_contract = (
        _source_bound_proposal_witness_contract(manifest)
    )
    source_bound_proposal_witnesses = (
        source_bound_proposal_witness_contract is not None
    )
    ...
    post_final_unmatched_commit_evidence = (
        _uses_post_final_convergence_unmatched_commit_evidence_contract(
            manifest
        )
    )
    ...
    v42_retention_contract = _v42_cycle1_retention_contract(
        runtime,
        expected=expected,
        manifest=manifest,
        excluded_repair_runtime=v28_repair_runtime,
    )
    excluded_repair_duration_s = _excluded_repair_fault_window_duration_s(
        manifest.manifest_id
    )
    effective_fault_window_duration_s = (
        excluded_repair_duration_s
    ...
    expected_repair_observation_contract = (
        _expected_excluded_repair_observation_contract(manifest.manifest_id)
    )
    ...
    if (
        ...
        if not post_final_unmatched_commit_evidence:
            _fail(
                "v36+ post-final-convergence unmatched commit evidence "
                "contract drifted"
            )
    elif post_final_unmatched_commit_contract_value is not None:
        _fail(
            "post-final-convergence unmatched commit evidence contract "
            "escaped exact v36+ scope"
        )
    expected_responsive_period = _expected_responsive_omission_period(
        manifest.manifest_id
    )
    if tiered:
        ...
        if future_tree_proposal_delivery:
            artifact_identity[
                ...
                else FUTURE_TREE_PROPOSAL_DELIVERY_CONTRACT_V2
                if manifest.manifest_id
                in {
                    V23_MANIFEST_ID,
                    V24_MANIFEST_ID,
        ...
        if source_bound_proposal_witnesses:
            assert source_bound_proposal_witness_contract is not None
            artifact_identity[
                "source_bound_proposal_witness_contract"
            ] = source_bound_proposal_witness_contract
    ...
    if v42_retention_contract is not None:
        source_scope = (
            _FACTORIAL_CAMPAIGN_RETENTION_SCOPE_V1
            if v28_repair_runtime
            else v42_retention_contract[0]
        )
        source_policy = (
            _AGGREGATE_RELAY_PER_ACTOR_ADMISSION_POLICY_V1
            if v28_repair_runtime
    ...
    if v28_repair_runtime:
        assert excluded_repair_duration_s is not None
            ...
            expected_repair_probe.update(
                {
                    ...
                    "canonical_responsive_degraded_actor_ids": list(
                        _V40_RESPONSIVE_DEGRADED_ACTORS
                    ),
        ...
        if v42_retention_contract is not None:
            artifact_identity["cycle1_responsive_cross_commit_retention"] = dict(
                _mapping(
                    runtime.get("cycle1_responsive_cross_commit_retention"),
                    "v42 cycle-1 reporter-retention contract",
                )
            )
    ...
    if (
        v42_retention_contract is not None
        or (
            v28_repair_runtime
            and manifest.manifest_id
            in {V40_MANIFEST_ID, V41_MANIFEST_ID}
        )
    ):
        expected_lines.add(_V40_RETENTION_CONFIG_LINE)
    ...
    if any(_V40_RETENTION_CONFIG_KEY in value for value in manager_argv):
        _fail("v40 retention-v2 config key escaped main.conf")
    validate_manager_blinding(
        manager_argv,
        (),
    )
    cycle1_selection_gate_enabled = (
        _uses_excluded_repair_cycle1_selection_gate(
            manifest_id=manifest.manifest_id,
            coverage_smoke=v28_repair_runtime,
            slot_id=expected.slot_id,
        )
    )
    historical_retention_gate_enabled = (
        manifest.manifest_id in {V40_MANIFEST_ID, V41_MANIFEST_ID}
        and v28_repair_runtime
    )
    gate_option_count = manager_argv.count(
        _CYCLE1_SELECTION_NOT_BEFORE_OPTION
    )
    gate_token_count = sum(
        value.count(_CYCLE1_SELECTION_NOT_BEFORE_TOKEN)
        for value in manager_argv
    )
    gate_template_valid = (
        gate_option_count == 1
        and manager_argv.index(_CYCLE1_SELECTION_NOT_BEFORE_OPTION) + 1
        < len(manager_argv)
        and manager_argv[
            manager_argv.index(_CYCLE1_SELECTION_NOT_BEFORE_OPTION) + 1
        ]
        == _CYCLE1_SELECTION_NOT_BEFORE_TOKEN
        and gate_token_count == 1
    )
    if cycle1_selection_gate_enabled and not gate_template_valid:
        _fail(
            "cycle-1 selection gate escaped exact v39 excluded repair scope"
        )
    if (
        not cycle1_selection_gate_enabled
        and (gate_option_count != 0 or gate_token_count != 0)
    ):
        _fail(
            "cycle-1 selection gate escaped exact v39 excluded repair scope"
        )
    if cycle1_selection_gate_enabled:
        fault_window = _mapping(runtime.get("fault_window"), "runtime fault_window")
        gate_offset_s = (
            _integer(
                fault_window.get("start_after_prelaunch_anchor_s"),
                "runtime fault-window start",
                1,
            )
            + _integer(
                fault_window.get("duration_s"),
                "runtime fault-window duration",
                1,
            )
            + _V39_POST_FAULT_SELECTION_OBSERVATION_GRACE_S
        )
        if gate_offset_s >= _integer(
            fault_window.get("hard_timeout_s"),
            "runtime hard timeout",
            1,
        ):
            _fail(
                "v39 cycle-1 selection gate does not precede the shared hard deadline"
            )
    eligibility_count = manager_argv.count(
        _CYCLE1_INHERITED_WAIT_EXEMPT_ELIGIBILITY_GATE_OPTION
    )
    retention_count = manager_argv.count(
        _CYCLE1_RESPONSIVE_CROSS_COMMIT_RETENTION_READINESS_GATE_OPTION
    )
    responsive_actors_count = manager_argv.count(
        _CYCLE1_RESPONSIVE_DEGRADED_ACTORS_OPTION
    )
    admission_policy_count = manager_argv.count(
        _CYCLE1_RESPONSIVE_CROSS_COMMIT_RETENTION_ADMISSION_POLICY_OPTION
    )
    expected_retention_actors = (
        v42_retention_contract[2]
        if v42_retention_contract is not None
        else _V40_RESPONSIVE_DEGRADED_ACTORS
    )
    responsive_actors_valid = (
        responsive_actors_count == 1
        and manager_argv.index(_CYCLE1_RESPONSIVE_DEGRADED_ACTORS_OPTION) + 1
        < len(manager_argv)
        and manager_argv[
            manager_argv.index(_CYCLE1_RESPONSIVE_DEGRADED_ACTORS_OPTION) + 1
        ]
        == ",".join(map(str, expected_retention_actors))
    )
    admission_policy_valid = (
        admission_policy_count == 1
        and manager_argv.index(
            _CYCLE1_RESPONSIVE_CROSS_COMMIT_RETENTION_ADMISSION_POLICY_OPTION
        )
        + 1
        < len(manager_argv)
    ...
    if v42_retention_contract is not None:
        inherited_required = (
            v42_retention_contract[0]
            == _EXCLUDED_REPAIR_S037_RETENTION_SCOPE_V1
        )
        if not (
            (eligibility_count == 1) is inherited_required
            and retention_count == 1
            and responsive_actors_valid
            and admission_policy_valid
        ):
            _fail("v42 retention-readiness manager gate contract drifted")
    elif historical_retention_gate_enabled:
        if not (
            eligibility_count == 1
            and retention_count == 1
            and responsive_actors_valid
            and admission_policy_count == 0
        ):
            _fail("v40 retention-readiness manager gate contract drifted")
    elif (
        eligibility_count != 0
        or retention_count != 0
        or responsive_actors_count != 0
        or admission_policy_count != 0
    ):
        _fail("v40 retention-readiness manager gates escaped exact S037")
    if manifest.manifest_id in {
        V33_MANIFEST_ID,
        V34_MANIFEST_ID,
        V35_MANIFEST_ID,
        ...
        if (
            manager_argv.count(deadline_option) != 1
            or manager_argv.index(deadline_option) + 1 >= len(manager_argv)
            or manager_argv[manager_argv.index(deadline_option) + 1]
            != str(_V33_TRANSITION_CONVERGENCE_DEADLINE_S)
        ):
            _fail("v33 manager argv does not carry the exact 30s convergence deadline")
    ...
    for replica_id, raw in enumerate(replica_templates):
        ...
        if any(_V40_RETENTION_CONFIG_KEY in value for value in argv):
            _fail("v40 retention-v2 config key escaped main.conf")
...
def _evidence_record(
    ...
    *,
    ...
    schema_version = _integer(
        ...
        f"{label}.observation.schema_version",
        1,
    )
    ...
    if schema_version == 2 and outcome != "timeout":
        _fail(f"{label} schema-v2 retention fact is not a schema-v2 timeout")
    ...
    if schema_version in {2, 3}:
        ...
        bounded_u64 = {
            ...
            "reporter_local_commit_monotonic_ns": reporter_local_commit,
        }
        if any(value > _UINT64_MAX for value in bounded_u64.values()):
            _fail(f"{label} schema-v2 timeout exceeds an unsigned 64-bit bound")
        if (
            reporter > (1 << 32) - 1
            or target > (1 << 32) - 1
            or epoch > (1 << 32) - 1
...
def _validate_v40_cross_commit_retention_ready(
    *,
    manager_events: Sequence[_NativeEvent],
    ...
    """Replay the exact v40 S037 admitted reporter-retention high water."""

    expected_marker_window = _string(
        actor_origin_marker_window_id,
        "actor-origin marker omission window",
    )
    if manifest_id == V40_MANIFEST_ID:
        diagnostic_version = 40
    elif manifest_id == V41_MANIFEST_ID:
    ...
    elif manifest_id == V44_MANIFEST_ID:
        diagnostic_version = 44
    elif manifest_id == V45_MANIFEST_ID:
        diagnostic_version = 45
    elif manifest_id == FROZEN_MANIFEST_ID:
        diagnostic_version = 46
    else:
    ...
    if len(ready_events) != 1:
        _fail("v40 cross-commit retention readiness is absent or duplicated")
    ...
    if (
        ...
        _fail("v40 cross-commit retention readiness source identity drifted")
    ...
    _fields(
        ...
        "v40 cross-commit retention readiness payload",
    )
    expected_digest = _digest(
        predecessor_epoch_digest,
        "v40 cross-commit retention predecessor digest",
    )
    cutoff = _integer(
        selection_current_cutoff,
        "v40 cross-commit retention selection cutoff",
        1,
    )
    selection_ns = _integer(
        epoch2_selection_ns,
        "v40 cross-commit retention Epoch2 selection",
        1,
    )
    if cutoff > _UINT64_MAX:
        _fail("v40 cross-commit retention selection cutoff exceeds u64")
    if (
        payload["cycle_ordinal"] != 1
        or payload["predecessor_epoch_number"] != 1
        or payload["predecessor_epoch_digest"] != expected_digest
    ):
        _fail("v40 retention readiness is not bound to the exact cycle-1 predecessor")
    ready_cutoff = _integer(
        payload["evidence_cutoff"],
        "v40 cross-commit retention readiness evidence cutoff",
        1,
    )
    if ready_cutoff != cutoff or ready_cutoff > _UINT64_MAX:
        _fail("v40 retention readiness does not use the same evidence cutoff")
    if not ready.monotonic_ns < selection_ns:
        _fail("v40 retention readiness does not strictly precede Epoch2 selection")

    expected_actors = tuple(
        _integer(actor, "v40 responsive-degraded actor", 0)
    ...
    if (
        ...
        _fail("v40 responsive-degraded actor cohort is not canonical")
    ready_actors = tuple(
        _integer(actor, "v40 readiness responsive-degraded actor", 0)
        for actor in _array(
            payload["responsive_degraded_actor_ids"],
            "v40 readiness responsive-degraded actor IDs",
        )
    )
    if ready_actors != expected_actors:
        _fail("v40 retention readiness actor cohort drifted")
    admitted_ids = tuple(
        _digest(value, "v40 readiness admitted observation ID")
        for value in _array(
            payload["admitted_observation_ids"],
            "v40 readiness admitted observation IDs",
        )
    )
    if (
        ...
        _fail("v40 readiness canonical observation membership drifted")
    ...
    for record in accepted_epoch1:
        ...
        if (
            ...
            _fail("v40 readiness observation state ordering is corrupted")
    ...
    for actor, observation_id in zip(expected_actors, admitted_ids):
        ...
        if admitted is None:
            _fail("v40 readiness admitted ID lacks one canonical observation")
        if admitted.schema_version != 2 or admitted.outcome != "timeout":
            _fail(
                "v40 readiness admitted ID is not an outstanding schema-v2 "
                "timeout at the evidence cutoff"
            )
        if admitted.target_id != actor:
            _fail("v40 readiness admitted ID actor differs from its canonical observation")
    ...
    for record in latest_at_cutoff.values():
        if (
            ...
            or record.target_id not in set(expected_actors)
        ):
            continue
        if record.acceptance_monotonic_ns >= selection_ns:
            _fail("v40 retention fact does not strictly precede Epoch2 selection")
        if (
            record.acceptance_source_sequence >= ready.source_sequence
            or record.acceptance_monotonic_ns > ready.monotonic_ns
        ):
            _fail("v40 retention fact was not accepted before readiness/selection")
        if (
            record.attempt_start_monotonic_ns is None
            or record.reporter_local_commit_monotonic_ns is None
        ):
            _fail("v40 readiness references a malformed schema-v2 timeout fact")
        candidates[record.target_id].append(record)

    selected: list[_EvidenceRecord] = []
    for actor in expected_actors:
        actor_candidates = candidates.get(actor, [])
        if not actor_candidates:
            _fail("v40 readiness lacks a canonical observation for every actor")
        ordered = sorted(
            actor_candidates,
            key=lambda record: (
                0 if record.message_type == "aggregate_relay" else 1,
        ...
        first = ordered[0]
        first_key = (
            0 if first.message_type == "aggregate_relay" else 1,
            first.ingestion_sequence,
        ...
        if any(
            ...
            _fail("v40 readiness canonical observation ordering is corrupted")
        selected.append(first)
    if tuple(record.observation_id for record in selected) != admitted_ids:
        _fail("v40 readiness admitted IDs differ from canonical observations")
    if not any(record.message_type == "aggregate_relay" for record in selected):
        _fail("v40 readiness lacks a selected aggregate_relay retention fact")
    ...
    for record in selected:
        ...
        expected_action = (
            "omit_aggregate"
            if record.message_type == "aggregate_relay"
        ...
        exact_markers = tuple(
            ...
            if (
                marker.source_replica == record.target_id
                ...
                and marker.fault_mode == _TIERED_OMISSION_MODE_V2
                and marker.window == expected_marker_window
                and marker.cohort == "responsive_degraded"
            )
        )
        if len(exact_markers) != 1:
            _fail(
                f"v{diagnostic_version} admitted fact lacks one exact "
                "actor-origin fault marker"
            )
        ...
        exact_arms = tuple(
            ...
            if (
                ...
                and arm.child_id == record.target_id
                and arm.proposal_key == key
                and arm.expected_message_type == record.message_type
            )
        )
        if len(exact_arms) != 1:
            _fail("v40 admitted fact lacks one exact response-attempt arm")
        arm = exact_arms[0]
        if arm.source_replica != record.reporter_id:
            _fail("v40 admitted fact arm differs from its authenticated reporter")
        if arm.start_monotonic_ns != record.attempt_start_monotonic_ns:
            _fail("v40 admitted fact attempt start differs from its raw arm")
        if arm.deadline_duration_us != record.deadline_duration_us:
            _fail("v40 admitted fact deadline duration differs from its raw arm")

        reporter_commits = commit_events(record.reporter_id, key)
        if len(reporter_commits) != 1:
            _fail("v40 admitted fact lacks one exact reporter-local rich commit")
        ...
        if reporter_commit_sample is None:
            _fail("v40 admitted fact lacks its reporter-local commit sample")
        if reporter_commit_sample != record.reporter_local_commit_monotonic_ns:
            _fail("v40 admitted fact reporter-local commit timestamp drifted")
        observer_commits = commit_events(0, key)
        if len(observer_commits) != 1:
            _fail("v40 admitted fact lacks one exact observer-0 rich commit")
        ...
        if not (
            ...
            _fail("v40 admitted fact violates its strict admitted-fact chronology")
        if not marker.monotonic_ns < observer_commit.monotonic_ns < selection_ns:
            _fail("v40 admitted fact observer-0 rich commit is outside its window")
    return tuple(selected)


def _validate_v42_cross_commit_retention_ready(
    *,
    manager_events: Sequence[_NativeEvent],
    accepted_epoch1: Sequence[_EvidenceRecord],
    responsive_degraded_actor_ids: Sequence[int],
    ...
    """Replay one exact aggregate-retention witness per v42 actor."""

    if scope not in {
        _FACTORIAL_CAMPAIGN_RETENTION_SCOPE_V1,
        _ORDERED_S066_COVERAGE_RETENTION_SCOPE_V1,
    }:
        _fail("v42 cross-commit retention scope is not generic or ordered S066")
    if admission_policy != _AGGREGATE_RELAY_PER_ACTOR_ADMISSION_POLICY_V1:
        _fail("v42 cross-commit retention policy is not aggregate_relay per actor")
    expected_marker_window = _string(
        actor_origin_marker_window_id,
        "v42 actor-origin marker omission window",
    )
    ready_events = tuple(
        event
        for event in manager_events
    ...
    if len(ready_events) != 1:
        _fail("v42 cross-commit retention readiness is absent or duplicated")
    ready = ready_events[0]
    if (
        ready.source_kind != "adaptation_manager"
        or ready.source_id != "adaptive-manager"
        ...
        _fail("v42 cross-commit retention readiness source identity drifted")
    payload = ready.payload
    _fields(
        payload,
        {
        ...
        "v42 cross-commit retention readiness payload",
    )
    expected_digest = _digest(
        predecessor_epoch_digest,
        "v42 cross-commit retention predecessor digest",
    )
    cutoff = _integer(
        selection_current_cutoff,
        "v42 cross-commit retention selection cutoff",
        1,
    )
    selection_ns = _integer(
        epoch2_selection_ns,
        "v42 cross-commit retention Epoch2 selection",
        1,
    )
    if cutoff > _UINT64_MAX:
        _fail("v42 cross-commit retention selection cutoff exceeds u64")
    if (
        payload["cycle_ordinal"] != 1
        or payload["predecessor_epoch_number"] != 1
        or payload["predecessor_epoch_digest"] != expected_digest
    ):
        _fail("v42 retention readiness is not bound to the exact cycle-1 predecessor")
    ready_cutoff = _integer(
        payload["evidence_cutoff"],
        "v42 cross-commit retention readiness evidence cutoff",
        1,
    )
    if ready_cutoff != cutoff or ready_cutoff > _UINT64_MAX:
        _fail("v42 retention readiness does not use the same evidence cutoff")
    if not ready.monotonic_ns < selection_ns:
        _fail("v42 retention readiness does not strictly precede Epoch2 selection")

    expected_actors = tuple(
        _integer(actor, "v42 responsive-degraded actor", 0)
        for actor in responsive_degraded_actor_ids
    )
    if (
        not expected_actors
        ...
        _fail("v42 responsive-degraded actor cohort is not canonical")
    ready_actors = tuple(
        _integer(actor, "v42 readiness responsive-degraded actor", 0)
        for actor in _array(
            payload["responsive_degraded_actor_ids"],
            "v42 readiness responsive-degraded actor IDs",
        )
    )
    if ready_actors != expected_actors:
        _fail("v42 retention readiness actor cohort drifted")
    admitted_ids = tuple(
        _digest(value, "v42 readiness admitted observation ID")
        for value in _array(
            payload["admitted_observation_ids"],
            "v42 readiness admitted observation IDs",
        )
    )
    if (
        len(admitted_ids) != len(expected_actors)
        ...
        _fail("v42 readiness canonical observation membership drifted")
    ...
    for record in accepted_epoch1:
        ...
        if (
            ...
            _fail("v42 readiness observation state ordering is corrupted")
        latest_at_cutoff[record.observation_id] = record
    for actor, observation_id in zip(expected_actors, admitted_ids):
        admitted = latest_at_cutoff.get(observation_id)
        if admitted is None:
            _fail("v42 readiness admitted ID lacks one canonical observation")
        if (
            ...
            _fail(
                "v42 readiness admitted ID is not an outstanding schema-v2 "
                "aggregate_relay timeout at the evidence cutoff"
            )
        if admitted.target_id != actor:
            _fail("v42 readiness admitted ID actor differs from its observation")
    ...
    for record in latest_at_cutoff.values():
        if (
            ...
            continue
        if record.acceptance_monotonic_ns >= selection_ns:
            _fail("v42 retention fact does not strictly precede Epoch2 selection")
        if (
            record.acceptance_source_sequence >= ready.source_sequence
            or record.acceptance_monotonic_ns > ready.monotonic_ns
        ):
            _fail("v42 retention fact was not accepted before readiness/selection")
        if (
            record.attempt_start_monotonic_ns is None
            or record.reporter_local_commit_monotonic_ns is None
        ):
            _fail("v42 readiness references a malformed schema-v2 timeout fact")
        candidates[record.target_id].append(record)
    ...
    for actor in expected_actors:
        ...
        if not ordered:
            _fail("v42 readiness lacks one aggregate_relay observation per actor")
        selected.append(ordered[0])
    if tuple(record.observation_id for record in selected) != admitted_ids:
        _fail("v42 readiness admitted IDs differ from canonical aggregate_relay facts")
    ...
    for record in selected:
        ...
        if tree is None or record.target_id not in tree.members:
            _fail("v42 admitted fact has no exact Epoch1 tree role")
        ...
        if not 0 < position < leaf_start:
            _fail("v42 admitted aggregate_relay actor is not an internal role")
        physical_parent = tree.members[(position - 1) // tree.fanout]
        if record.reporter_id != physical_parent:
            _fail("v42 admitted fact differs from its exact physical parent")
        ...
        if len(exact_markers) != 1:
            _fail("v42 admitted fact lacks one exact actor-origin fault marker")
        marker = exact_markers[0]

        exact_arms = tuple(
            arm
            for arm in arm_markers
            if arm.reporter_id == record.reporter_id
            and arm.child_id == record.target_id
            and arm.proposal_key == key
            and arm.expected_message_type == "aggregate_relay"
        )
        if len(exact_arms) != 1:
            _fail("v42 admitted fact lacks one exact response-attempt arm")
        arm = exact_arms[0]
        if arm.source_replica != record.reporter_id:
            _fail("v42 admitted fact arm differs from its authenticated reporter")
        if arm.start_monotonic_ns != record.attempt_start_monotonic_ns:
            _fail("v42 admitted fact attempt start differs from its raw arm")
        if arm.deadline_duration_us != record.deadline_duration_us:
            _fail("v42 admitted fact deadline duration differs from its raw arm")
        if (
            ...
            _fail("v42 admitted fact arm absolute deadline is invalid")

        reporter_commits = commit_events(record.reporter_id, key)
        if len(reporter_commits) != 1:
            _fail("v42 admitted fact lacks one exact reporter-local rich commit")
        reporter_commit = reporter_commits[0]
        reporter_commit_payload = _commit_payload(
            reporter_commit,
            authoritative=record.reporter_id == 0,
        ...
        if reporter_commit_sample is None:
            _fail("v42 admitted fact lacks its reporter-local commit sample")
        if reporter_commit_sample != record.reporter_local_commit_monotonic_ns:
            _fail("v42 admitted fact reporter-local commit timestamp drifted")
        if not 0 < reporter_commit_sample <= reporter_commit.monotonic_ns:
            _fail("v42 admitted fact sample exceeds its rich commit outer event time")
        if reporter_commit.monotonic_ns >= selection_ns:
            _fail("v42 admitted fact reporter rich commit is not pre-selection")

        observer_commits = commit_events(0, key)
        if len(observer_commits) != 1:
            _fail("v42 admitted fact lacks one exact observer-0 rich commit")
        observer_commit = observer_commits[0]
        if not (
            record.attempt_start_monotonic_ns
            <= marker.monotonic_ns
            ...
            _fail("v42 admitted fact violates its strict shared-sample chronology")
        if not marker.monotonic_ns < observer_commit.monotonic_ns < selection_ns:
...
def _snapshot_id(
    ...
    *,
    ...
    for record in records:
        ...
        result += _u(record.schema_version, 4) + bytes.fromhex(record.observation_id)
        ...
        if record.schema_version in {2, 3}:
            ...
            _fail("snapshot record schema version is unsupported")
...
_REPORTER_LOCAL_COMMIT_SAMPLE_FIELD = (
    "reporter_local_commit_monotonic_ns"
)
...
def _commit_payload(
    ...
    *,
    authoritative: bool,
    allow_reporter_local_commit_sample: bool = False,
) -> dict[str, Any]:
    ...
    if event.event_type == "block.committed":
        ...
        if _REPORTER_LOCAL_COMMIT_SAMPLE_FIELD in payload:
            if not allow_reporter_local_commit_sample:
                _fail(
                    f"{label}.{_REPORTER_LOCAL_COMMIT_SAMPLE_FIELD} escaped "
                    "exact v40 S037"
                )
            expected_fields.add(_REPORTER_LOCAL_COMMIT_SAMPLE_FIELD)
    _fields(payload, expected_fields, label)
    height = _integer(payload["block_height"], f"{label}.block_height", 1)
    if height > _UINT64_MAX:
        _fail(f"{label}.block_height exceeds the fixed uint64 bound")
    ...
    if batch_index > _UINT64_MAX:
        _fail(f"{label}.commit_batch_index exceeds the fixed uint64 bound")
    reporter_local_commit_sample: int | None = None
    if event.event_type == "block.committed":
        ...
        if payload["view_generation"] is not None:
            view_generation = _integer(
                payload["view_generation"],
                f"{label}.view_generation",
            )
            if view_generation > _UINT64_MAX:
                _fail(f"{label}.view_generation exceeds the fixed uint64 bound")
        if _REPORTER_LOCAL_COMMIT_SAMPLE_FIELD in payload:
            reporter_local_commit_sample = _integer(
                payload[_REPORTER_LOCAL_COMMIT_SAMPLE_FIELD],
                f"{label}.{_REPORTER_LOCAL_COMMIT_SAMPLE_FIELD}",
                1,
            )
            if reporter_local_commit_sample > _UINT64_MAX:
                _fail(
                    f"{label}.{_REPORTER_LOCAL_COMMIT_SAMPLE_FIELD} exceeds "
                    "the unsigned 64-bit bound"
                )
            if reporter_local_commit_sample > event.monotonic_ns:
                _fail(
                    f"{label}.{_REPORTER_LOCAL_COMMIT_SAMPLE_FIELD} is after "
                    "its structured commit event"
                )
    return {
        "height": height,
        "hash": block_hash,
        ...
        "reporter_local_commit_monotonic_ns": reporter_local_commit_sample,
    }


def _v40_commit_retention_compat_events(
    replica_events: Mapping[int, Sequence[_NativeEvent]],
    *,
    enabled: bool,
) -> dict[int, tuple[_NativeEvent, ...]]:
    """Validate v40-only commit samples, then project legacy commit bytes."""

    projected: dict[int, tuple[_NativeEvent, ...]] = {}
    for replica_id, events in replica_events.items():
        projected_events: list[_NativeEvent] = []
        for event in events:
            has_sample = _REPORTER_LOCAL_COMMIT_SAMPLE_FIELD in event.payload
            if not has_sample:
                projected_events.append(event)
                continue
            if not enabled:
                _fail(
                    "reporter-local commit sample escaped exact v40 S037"
                )
            if event.event_type != "block.committed":
                _fail(
                    "reporter-local commit sample escaped exact v40 "
                    "block.committed"
                )
            _commit_payload(
                event,
            ...
            del payload[_REPORTER_LOCAL_COMMIT_SAMPLE_FIELD]
            projected_events.append(replace(event, payload=payload))
        projected[replica_id] = tuple(projected_events)
    return projected


def _commit_identity_key(commit: Mapping[str, Any]) -> tuple[int, str, str | None, int, int]:
    return (
        commit["height"],
        commit["hash"],
        commit["parent"],
...
def _commit_identity_unavailable_payload(
    event: _NativeEvent,
) -> tuple[int, str, str | None, int, int]:
    """Parse the one exact structured v36 non-authoritative gap marker."""
    ...
    batch_index = _integer(
        ...
        f"{label}.commit_batch_index",
    )
    if batch_index > _UINT64_MAX:
        _fail(f"{label}.commit_batch_index exceeds the fixed uint64 bound")
    if payload["reason"] != "no_authenticated_exact_identity_source":
        _fail(f"{label}.reason is not the exact v36 unavailable reason")
    if payload["convergence_identity_pending"] is not False:
        _fail(f"{label} is not an outside-convergence pending disposition")
    return height, block_hash, parent, transactions, batch_index


def _validate_manifest_commit_identity_unavailable(
    manifest_id: str,
    replica_events: Mapping[int, Sequence[_NativeEvent]],
    *,
    replica_count: int,
    ...
    has_marker = any(
        event.event_type == marker_type
        for events in replica_events.values()
        for event in events
    )
    if manifest_id not in _V36_PLUS_COMMIT_IDENTITY_UNAVAILABLE_MANIFEST_IDS:
        if has_marker:
            _fail(
    ...
    if set(replica_events) != set(range(replica_count)):
        _fail(
            "v36 commit identity gap evidence does not cover every configured "
            "replica"
        )
    terminal_ns = _integer(
        final_cycle_terminal_ns,
        "v36 final adaptation cycle terminal timestamp",
        1,
    )
    hard_ns = _integer(
        hard_deadline_ns,
        "v36 shared hard deadline timestamp",
        1,
    )
    if terminal_ns >= hard_ns:
        _fail("v36 final cycle terminal does not precede the hard deadline")
    ...
    observations: dict[
        tuple[int, str, str | None, int, int],
        dict[int, list[_NativeEvent]],
    ] = defaultdict(lambda: defaultdict(list))
    rich_commits: dict[
        tuple[int, str, str | None, int, int],
        dict[int, list[tuple[_NativeEvent, tuple[int, int, str, int]]]],
    ] = defaultdict(lambda: defaultdict(list))
    markers: dict[
        tuple[int, str, str | None, int, int],
        dict[int, list[_NativeEvent]],
    ...
    for replica_id in range(replica_count):
        events = replica_events[replica_id]
        expected_source_id = f"replica-{replica_id}"
        for index, event in enumerate(events):
            ...
            if (
                ...
                or event.source_id != expected_source_id
                or (
                    event.source_id == observer_id
                    and event.source_instance != observer_instance
                )
            ):
                _fail("v36 commit identity evidence has an invalid exact reporter")

            if event.event_type == "block.commit_observed":
                commit = _commit_payload(event, authoritative=False)
                observations[_commit_identity_key(commit)][replica_id].append(event)
                continue
            if event.event_type == "block.committed":
                authoritative = event.source_id == observer_id
                commit = _commit_payload(event, authoritative=authoritative)
                generation = _integer(
                    event.payload["view_generation"],
                    "v36 rich commit view generation",
                    1,
                )
                if generation > _UINT64_MAX:
                    _fail("v36 rich commit view generation exceeds uint64")
                rich_identity = (
                    commit["epoch_number"],
                    commit["tree_id"],
                    commit["epoch_digest"],
                ...
                rich_commits[_commit_identity_key(commit)][replica_id].append(
                    (event, rich_identity)
                )
                continue

            marker_key = _commit_identity_unavailable_payload(event)
            prior_markers = markers[marker_key][replica_id]
            if prior_markers:
            ...
            if event.monotonic_ns <= terminal_ns:
                _fail(
                    ...
                    "follow the final cycle terminal"
                )
            if event.monotonic_ns >= hard_ns:
                _fail(
                    "v36 commit identity unavailable marker does not strictly "
            ...
            if index == 0:
                _fail(
                    "v36 commit identity unavailable marker is not the immediate "
                    "same-source successor of an observation"
                )
            observation = events[index - 1]
            if (
                observation.event_type != "block.commit_observed"
                or observation.source_kind != event.source_kind
                or observation.source_id != event.source_id
                or observation.source_instance != event.source_instance
                or observation.relative_path != event.relative_path
                or observation.source_sequence + 1 != event.source_sequence
                or observation.line_number + 1 != event.line_number
                or observation.monotonic_ns > event.monotonic_ns
            ):
                _fail(
                    "v36 commit identity unavailable marker is not the immediate "
                    "same-source successor of an observation"
                )
            observed_key = _commit_identity_key(
                _commit_payload(observation, authoritative=False)
            )
            if observed_key != marker_key:
                _fail(
                    "v36 commit identity unavailable marker does not name the "
                    "same observed commit tuple"
                )

    for key, markers_by_reporter in markers.items():
        if set(observations.get(key, {})) != set(range(replica_count)):
            _fail(
                "v36 commit identity gap does not have the same observed commit "
                "tuple at every configured replica"
            )
        if any(
            len(observations[key][replica_id]) != 1
            for replica_id in range(replica_count)
        ):
            _fail(
                "v36 commit identity gap lacks exactly one observation at every "
                "configured replica"
            )
        if any(
            event.monotonic_ns >= hard_ns
            for reporter_observations in observations[key].values()
            for event in reporter_observations
        ):
            _fail(
                "v36 commit identity gap matching observation does not strictly "
                "precede the shared hard deadline"
            )
        for replica_id, reporter_markers in markers_by_reporter.items():
            if len(reporter_markers) != 1:
                _fail("v36 commit identity unavailable marker is duplicated")
            if len(observations[key][replica_id]) != 1:
                _fail(
                    "v36 commit identity unavailable marker lacks exactly one "
                    "same-source observation"
                )

        rich_by_reporter = rich_commits.get(key, {})
        if len(rich_by_reporter) < quorum:
            _fail(
                "v36 commit identity gap lacks the independently derived rich "
                "commit quorum"
            )
        if any(
            event.monotonic_ns >= hard_ns
            for reporter_proofs in rich_by_reporter.values()
            for event, _identity in reporter_proofs
        ):
            _fail(
        ...
        if any(
            ...
            _fail(
                "v36 rich commit quorum has configuration/generation identity "
                "drift"
            )

    all_keys = set(observations) | set(rich_commits) | set(markers)
    for key in all_keys:
        for replica_id in range(replica_count):
            observed = observations.get(key, {}).get(replica_id, ())
            rich = rich_commits.get(key, {}).get(replica_id, ())
            unavailable = markers.get(key, {}).get(replica_id, ())
            if len(observed) > 1:
                _fail(
                    "v36 commit identity tuple lacks exactly one reporter "
                    "observation"
                )
            if len(rich) > 1:
                _fail("v36 commit identity tuple duplicated a rich commit proof")
            if rich and len(observed) != 1:
                _fail(
                    "v36 rich commit proof lacks exactly one same-source "
                    "observation"
                )
            if rich and unavailable:
                _fail(
                    "v36 reporter emitted both rich and unavailable commit "
                    "identity evidence"
                )
            if observed and not rich and not unavailable:
                if f"replica-{replica_id}" == observer_id:
                    _fail(
                        "v36 designated observer commit observation lacks its "
                        "rich commit proof"
                    )
                _fail(
...
def _final_adaptation_cycle_terminal_ns(
    ...
    if len(terminal_events) != 1:
        _fail("v36 final adaptation cycle terminal is absent or duplicated")
...
def _validate_authoritative_observer_commit_completeness(
    ...
    *,
    ...
    observed_by_key: dict[
        tuple[int, str, str | None, int, int], list[_NativeEvent]
    ] = defaultdict(list)
    committed_by_key: dict[
        tuple[int, str, str | None, int, int], list[_NativeEvent]
    ] = defaultdict(list)
    relative_paths: set[str] = set()
    for event in observer_events:
        if event.event_type not in {"block.commit_observed", "block.committed"}:
            continue
        if (
            event.source_kind != "replica"
            or event.source_id != observer_id
            or event.source_instance != observer_instance
        ):
            _fail(
                "authoritative observer commit evidence escaped its exact "
                "same-source stream"
            )
        relative_paths.add(event.relative_path)
        authoritative = event.event_type == "block.committed"
        commit = _commit_payload(event, authoritative=authoritative)
        key = (
            commit["height"],
            commit["hash"],
        ...
        if not authoritative:
            observed_by_key[key].append(event)
            continue

        view_generation = event.payload["view_generation"]
        if view_generation is None:
            _fail(
                "authoritative observer committed proof lacks its exact view "
                "generation"
            )
        generation = _integer(
            view_generation,
            "authoritative observer committed proof view generation",
            1,
        )
        if generation > _UINT64_MAX:
            _fail(
                "authoritative observer committed proof view generation "
                "exceeds its unsigned 64-bit bound"
            )
        configuration = (commit["epoch_number"], commit["epoch_digest"])
        tree_ids = tree_ids_by_configuration.get(configuration)
        if tree_ids is None or not tree_ids:
            _fail(
                "authoritative observer committed proof lacks its exact "
                "configuration"
            )
        tree_id = commit["tree_id"]
        if tree_id not in tree_ids:
            _fail(
                "authoritative observer committed proof tree is outside its "
                "exact configuration"
            )
        packed_generation = generation - 1
        generation_epoch = packed_generation >> 32
        rotation_ordinal = packed_generation & 0xFFFF_FFFF
        if generation_epoch != commit["epoch_number"]:
            _fail(
                "authoritative observer committed proof generation epoch "
                "differs from its exact configuration"
            )
        if tree_ids[rotation_ordinal % len(tree_ids)] != tree_id:
            _fail(
                "authoritative observer committed proof generation rotation "
                "differs from its exact tree"
            )
        committed_by_key[key].append(event)

    if len(relative_paths) > 1:
        _fail(
            "authoritative observer commit evidence spans more than one raw "
            "source path"
        )
    ordered_keys = tuple(observed_by_key) + tuple(
        key for key in committed_by_key if key not in observed_by_key
    )
    for key in ordered_keys:
        observations = observed_by_key.get(key, ())
        committed = committed_by_key.get(key, ())
        if len(observations) != 1:
            _fail(
                "authoritative observer commit identity lacks exactly one "
                "commit observation"
            )
        if len(committed) != 1:
        ...
        proof = committed[0]
        if (
            observation.source_sequence >= proof.source_sequence
            or observation.line_number >= proof.line_number
            or observation.monotonic_ns > proof.monotonic_ns
        ):
            _fail(
                "authoritative observer committed proof does not follow its "
                "exact same-source observation"
            )


def _uses_authoritative_observer_commit_completeness(manifest_id: str) -> bool:
    """Keep the observer completeness gate across exact frozen v35+."""
...
def _validate_manifest_authoritative_observer_commit_completeness(
    manifest_id: str,
    observer_events: Sequence[_NativeEvent],
    *,
    observer_id: str,
...
def _fault_contribution_opportunities(
    replica_events: Mapping[int, Sequence[_NativeEvent]],
    *,
    source_bound_proposal_witness_contract: str = (
        SOURCE_BOUND_PROPOSAL_WITNESS_CONTRACT_V1
    ),
    ...
    if source_bound_proposal_witness_contract not in {
        ...
        _fail("fault contribution opportunity received an unknown source contract")
    authenticated_source_v2 = (
        source_bound_proposal_witness_contract
        == SOURCE_BOUND_PROPOSAL_WITNESS_CONTRACT_V2
    )
    ...
    if authenticated_source_v2:
        expected_payload_fields.add("authenticated_proposal_source_replica")
            ...
            opportunity = FaultContributionOpportunity(
                ...
                authenticated_proposal_source_replica=(
                    uint64(
                        ...
                        f"{label} authenticated proposal source replica",
                    )
                    if authenticated_source_v2
                    else None
                ),
...
def _validate_fault_contribution_opportunity_bijection(
    *,
    ...
    for identity, marker in marker_by_identity.items():
        ...
        if authenticated_source_v2 and (
            opportunity.authenticated_proposal_source_replica
            != expected_parent
        ):
            _fail(
                "v46 contribution opportunity authenticated first proposal "
                "source differs from its exact physical parent"
            )
        if (
            not authenticated_source_v2
            and opportunity.authenticated_proposal_source_replica is not None
        ):
            _fail(
                "historical contribution opportunity carries a v46 "
                "authenticated proposal source"
            )
...
def _validate_v46_global_process_log_poison_gate(
    slot_root: Path,
    *,
    manifest_id: str,
    runtime: Mapping[str, Any],
) -> None:
    """Reject any v46 native convergence poison in every declared process log."""

    if manifest_id != FROZEN_MANIFEST_ID:
        return

    logs = _mapping(runtime.get("process_logs"), "v46 runtime process logs")
    _fields(
        logs,
        {
            "manager_stdout_relative_path",
            "manager_stderr_relative_path",
            "replica_stdout_relative_paths",
            "replica_stderr_relative_paths",
            "kauri_fault_marker_relative_paths",
            "exclusive_output_per_process",
        },
        "v46 runtime process-log schema",
    )
    manager_paths = (
        _string(
            logs["manager_stdout_relative_path"],
            "v46 manager stdout process log",
        ),
        _string(
            logs["manager_stderr_relative_path"],
            "v46 manager stderr process log",
        ),
    )
    stdout_paths = tuple(
        _string(path, "v46 replica stdout process log")
        for path in _array(
            logs["replica_stdout_relative_paths"],
            "v46 replica stdout process logs",
        )
    )
    stderr_paths = tuple(
        _string(path, "v46 replica stderr process log")
        for path in _array(
            logs["replica_stderr_relative_paths"],
            "v46 replica stderr process logs",
        )
    )
    fault_paths = tuple(
        _string(path, "v46 KAURI_FAULT process log")
        for path in _array(
            logs["kauri_fault_marker_relative_paths"],
            "v46 KAURI_FAULT process logs",
        )
    )
    expected_fault_paths = tuple(
        path
        for pair in zip(stdout_paths, stderr_paths)
        for path in pair
    )
    all_paths = (*manager_paths, *stdout_paths, *stderr_paths)
    if (
        not stdout_paths
        or len(stdout_paths) != len(stderr_paths)
        or fault_paths != expected_fault_paths
        or logs["exclusive_output_per_process"] is not True
        or len(set(all_paths)) != len(all_paths)
    ):
        _fail("v46 global process-log poison gate received a drifted path set")
    ...
    for relative in all_paths:
        ...
        try:
            if path.stat().st_size > _MAX_EVENT_STREAM_BYTES:
                _fail(f"v46 process log exceeds its fixed bound: {relative}")
            with path.open("rb") as stream:
                for line_number, raw in enumerate(stream, start=1):
                    if len(raw) > _MAX_EVENT_LINE_BYTES:
                        _fail(
                            f"{relative}:{line_number} exceeds the line bound"
                        )
                    deadline_count = raw.count(_RESPONSE_DEADLINE_POISON)
                    unhealthy_count = raw.count(_CONVERGENCE_UNHEALTHY_PREFIX)
                    if not deadline_count and not unhealthy_count:
                        continue
                    if (
                        deadline_count + unhealthy_count != 1
                        or deadline_count > 1
                        or unhealthy_count > 1
                    ):
                        _fail(
                            "v46 process logs contain malformed/duplicate "
                            "convergence poison"
                        )
                    if deadline_count:
                        _fail(
                            "v46 process logs contain response deadline poison"
                        )
                    _fail("v46 process logs contain convergence-unhealthy poison")
        except OSError as error:
            raise _Incomplete(
                f"cannot read v46 process log {relative}"
            ) from error
...
def _proposal_commit_identity(
    ...
    *,
    ...
    commit = _commit_payload(
        event,
        authoritative=replica_id == 0,
        allow_reporter_local_commit_sample=(
            allow_reporter_local_commit_sample
        ),
    )
    return (
...
def validate_fault_causality(
    *,
    ...
    fault_active_phase_contract: str | None = None,
    prevalidated_internal_retention_witness_actor_ids: Sequence[int] = (),
) -> int:
    ...
    if source_bound_proposal_witness_contract not in {
        ...
        _fail("fault causality received an unknown source-bound proposal contract")
    authenticated_source_v2 = (
        source_bound_proposal_witness_contract
        == SOURCE_BOUND_PROPOSAL_WITNESS_CONTRACT_V2
    )
    ...
    repair_fault_active_scope = fault_active_phase_contract is not None
    if repair_fault_active_scope:
        if fault_active_phase_contract != (
            _EXCLUDED_REPAIR_FAULT_ACTIVE_PHASE_SCOPE_V1
        ):
            _fail("fault causality received an unknown fault-active phase contract")
        if any(marker.epoch_number == 2 for marker in markers):
            _fail("v34 repair fault-active scope contains an Epoch2 KAURI_FAULT marker")
        if any(
            opportunity.epoch_number == 2
            for opportunity in contribution_opportunities
        ):
            _fail(
                "v34 repair fault-active scope contains an Epoch2 contribution "
                "opportunity"
            )
        if not (
            window_start_ns <= fault_phase[0] < fault_phase[1]
            <= epoch1_command_ns
            and fault_phase[1] <= window_end_ns
            and epoch1_activation_ns <= epoch1_phase[0] < epoch1_phase[1]
            < window_end_ns
            and window_end_ns < epoch2_phase[0] < epoch2_phase[1]
        ):
            _fail(
                "v34 repair fault-active phase windows are outside their exact "
                "physical-fault bounds"
            )
        fault_active_phase_configurations = phase_configurations[:2]
    else:
        if not (
            window_start_ns <= fault_phase[0] < fault_phase[1]
            and epoch1_activation_ns <= epoch1_phase[0] < epoch1_phase[1]
        ...
        fault_active_phase_configurations = phase_configurations
    if (
    ...
    if source_bound_contribution_opportunities:
        ...
        _validate_fault_contribution_opportunity_bijection(
            ...
            phase_configurations=fault_active_phase_configurations,
            source_bound_proposal_witness_contract=(
                source_bound_proposal_witness_contract
                or SOURCE_BOUND_PROPOSAL_WITNESS_CONTRACT_V1
            ),
        )
    ...
    for marker in markers:
        ...
        if explicit_phase_edge_eligibility and marker.actor in degraded:
            ...
            if (
                authenticated_source_v2
                and exact_arm.start_monotonic_ns > marker.monotonic_ns
            ):
                _fail(
                    "v46 parent response-attempt arm starts after its child "
                    "omission marker"
                )
    ...
    if require_cross_commit_retention_witnesses:
        ...
        prevalidated = tuple(prevalidated_internal_retention_witness_actor_ids)
        if prevalidated:
            if prevalidated != tuple(sorted(degraded)):
                _fail(
                    "prevalidated retention witnesses do not cover the exact "
                    "responsive-degraded actor cohort"
                )
            internal_retention_witnesses = prevalidated
        else:
            internal_retention_witnesses = (
    ...
    elif prevalidated_internal_retention_witness_actor_ids:
        _fail("prevalidated retention witnesses require cross-commit validation")
    ...
    if missing_epoch2_leaf and not repair_fault_active_scope:
        _fail(
...
def _validate_v40_main_config_receipt_binding(
    receipt: Mapping[str, Any],
    *,
    slot_root: Path,
    required: bool,
) -> None:
    field = "main_config_sha256"
    if not required:
        if field in receipt:
            _fail("main-config receipt binding escaped exact v40 S037")
        return
    if field not in receipt:
        _fail("v40 S037 main-config receipt binding is required")
    recorded = _digest(receipt[field], "v40 S037 main-config receipt digest")
    payload = _read_bytes(slot_root, "runtime/main.conf")
    assert payload is not None
    if recorded != _sha256(payload):
        _fail("v40 S037 main-config receipt differs from actual main.conf bytes")
    try:
        lines = payload.decode("ascii").splitlines()
    except UnicodeDecodeError as error:
        raise _Reject("v40 S037 main.conf is not canonical ASCII") from error
    keyed = tuple(
        line
        for line in lines
        if line.split("=", 1)[0].strip() == _V40_RETENTION_CONFIG_KEY
    )
    if keyed != (_V40_RETENTION_CONFIG_LINE,):
        _fail("v40 S037 main.conf lacks its exact retention-v2 config line")


def _validate_main_config_receipt_provenance(
    receipt: Mapping[str, Any],
    input_rows: Sequence[Mapping[str, Any]],
) -> None:
    if "main_config_sha256" not in receipt:
        return
    recorded = _digest(
        receipt["main_config_sha256"],
        "main-config receipt provenance digest",
    )
    rows = tuple(
        row
        for row in input_rows
        if row.get("kind") == "main_config"
        and row.get("relative_path") == "runtime/main.conf"
    )
    if len(rows) != 1 or rows[0].get("sha256") != recorded:
        _fail(
            "v40 main-config receipt does not match its sealed input-artifact"
        )


def _validate_v42_retention_receipt_binding(
    receipt: Mapping[str, Any],
    runtime: Mapping[str, Any],
    *,
    manifest_id: str,
    ...
    if required:
        if receipt.get(field) != expected:
            _fail("v42 slot receipt reporter-retention contract drifted")
    elif field in receipt:
        _fail("v42 slot receipt reporter-retention contract escaped its scope")
...
def _validate_slot_receipt(
    ...
    *,
    ...
    if readiness_required:
        receipt_fields.add("main_config_sha256")
    if v42_retention:
        receipt_fields.add("cycle1_responsive_cross_commit_retention")
    _fields(
        document,
        receipt_fields,
        SLOT_FILENAME,
    )
    _validate_v40_main_config_receipt_binding(
        document,
        slot_root=slot_root,
        required=readiness_required,
    )
    _validate_v42_retention_receipt_binding(
        document,
        runtime,
        manifest_id=manifest.manifest_id,
    )
    ...
    coverage_smoke = (
        expected.slot_id in _coverage_smoke_slot_ids(manifest.manifest_id)
        and runtime.get("result_path")
        == (
            f"{_coverage_smoke_result_root(manifest.manifest_id)}/"
            f"{expected.slot_id}"
    ...
    gate_target_ns = window_end + (
        _V39_POST_FAULT_SELECTION_OBSERVATION_GRACE_S
        * _NANOSECONDS_PER_SECOND
    )
    hard_deadline_ns = anchor + _integer(
        fault_window.get("hard_timeout_s"),
        "runtime.fault_window.hard_timeout_s",
        1,
    ) * _NANOSECONDS_PER_SECOND
    if cycle1_selection_gate_enabled and (
        gate_target_ns > _UINT64_MAX
        or hard_deadline_ns > _UINT64_MAX
        or gate_target_ns >= hard_deadline_ns
    ):
        _fail(
            "v39 cycle-1 selection gate does not fit before the shared hard deadline"
        )
    ...
    if cycle1_selection_gate_enabled and not gate_value_valid:
        _fail(
            "slot receipt does not bind the exact v39 cycle-1 selection gate"
        )
    if not cycle1_selection_gate_enabled and (
        _CYCLE1_SELECTION_NOT_BEFORE_OPTION in manager_argv
        or any(
            _CYCLE1_SELECTION_NOT_BEFORE_TOKEN in value
            for value in manager_argv
        )
    ):
        _fail(
...
def _validate_execution_provenance(
    ...
    *,
    ...
    _validate_main_config_receipt_provenance(receipt, input_rows)
    ...
    *,
    ...
    if manifest_id in {
        ...
        hard_deadline = _integer(
            hard_deadline_ns,
            "v40 runner shared hard deadline",
            1,
        )
        if hard_deadline > _UINT64_MAX:
            _fail("v40 runner shared hard deadline exceeds u64")
        if timestamps[-1] >= hard_deadline:
            _fail("v40 runner terminal did not precede the shared hard deadline")
...
def _validate_v28_excluded_repair_observation(
    ...
    *,
    ...
    if expected_observation_contract is None:
        _fail("v28+ excluded repair observation contract is not versioned")
    ...
    epoch2_lower_bound = fault_end
    uses_v39_observation_grace = (
        manifest.manifest_id
        in {
            V39_MANIFEST_ID,
            V40_MANIFEST_ID,
    ...
    if uses_v39_observation_grace:
        grace_ns = (
            _V39_POST_FAULT_SELECTION_OBSERVATION_GRACE_S
            * _NANOSECONDS_PER_SECOND
        )
        if fault_end > _UINT64_MAX - grace_ns:
            _fail("v39 excluded repair fault-end-plus-5s gate overflows u64")
        epoch2_lower_bound = fault_end + grace_ns
    if not (
        epoch2_lower_bound < timestamps["epoch2_selection"]
        and epoch2_lower_bound < timestamps["epoch2_command"]
        and all(
            epoch2_lower_bound < event.monotonic_ns
            for events in replica_events.values()
            for event in events
            if event.event_type == "epoch.command_committed"
        ...
        if uses_v39_observation_grace:
            _fail(
                "v39 excluded repair Epoch2 selection/all-replica commands did "
                "not strictly follow the materialized fault-end-plus-5s gate"
            )
        _fail(
    ...
    return expected_observation_contract
    ...
    *,
    ...
    hard_deadline = (
        ...
        if hard_deadline_ns is None
            ...
            hard_deadline_ns,
            "v33 shared hard deadline",
            1,
        )
    )
    if hard_deadline is not None and hard_deadline > _UINT64_MAX:
        _fail("v33 shared hard deadline exceeds uint64")
    ...
    cycle0_command_times: dict[int, int] = {}
    ...
    for replica_id in range(expected.replica_count):
        ...
        cycle0_command_times[replica_id] = commands[0].monotonic_ns
    ...
    if hard_deadline is not None:
        cycle0_quorum_ns = sorted(cycle0_activation_times.values())[expected.q - 1]
        cycle1_quorum_ns = sorted(activation_times.values())[expected.q - 1]
        if cycle0_quorum_ns >= hard_deadline or cycle1_quorum_ns >= hard_deadline:
            _fail("v33 raw activation quorum does not precede the shared hard deadline")
    if (
    ...
    if hard_deadline is not None:
        if (
            cycle0_converged.monotonic_ns >= hard_deadline
            or converged.monotonic_ns >= hard_deadline
        ):
            _fail("v33 adaptive_v2_converged does not precede the shared hard deadline")
        if any(
            timestamp >= hard_deadline
            for timestamp in (
                *cycle0_command_times.values(),
                *cycle0_activation_times.values(),
                *command_times.values(),
                *activation_times.values(),
            )
        ):
            _fail(
                "v33 all raw command/activation witnesses must precede the "
    ...
    if hard_deadline is not None and terminal.monotonic_ns >= hard_deadline:
        _fail("v33 cycle-1 terminal does not precede the shared hard deadline")
...
def _validate_native_transitions(
    *,
    ...
    if (
        ...
        if hard_deadline_ns is None:
            _fail("v33 N=31 transition validation lacks the shared hard deadline")
        _v26_cycle1_convergence_command(
            expected=expected,
            manager_events=manager_events,
            replica_events=replica_events,
...
def validate_slot(
    ...
    *,
    ...
    try:
        ...
        runner_hard_deadline_ns = (
            anchor_ns
            + manifest.common_timers.hard_timeout_s
            * _NANOSECONDS_PER_SECOND
        )
        _validate_runner_state(
            ...
            anchor_ns=anchor_ns,
            manifest_id=(
                manifest.manifest_id if v40_plus_repair else None
            ),
            hard_deadline_ns=(
                runner_hard_deadline_ns if v40_plus_repair else None
            ),
        )
        ...
        _validate_v46_global_process_log_poison_gate(
            slot_root,
            manifest_id=manifest.manifest_id,
            runtime=runtime,
        )
        ...
        v28_excluded_repair = _uses_excluded_repair_observation(
            manifest_id=manifest.manifest_id,
            coverage_smoke=coverage_smoke,
            slot_id=expected.slot_id,
        )
        slot_v42_retention = _v42_cycle1_retention_contract(
            runtime,
            expected=expected,
            manifest=manifest,
            excluded_repair_runtime=v28_excluded_repair,
        )
        v40_plus_repair = (
            manifest.manifest_id
            in {
        ...
        replica_events = _v40_commit_retention_compat_events(
            raw_replica_events,
            enabled=(v40_plus_repair or slot_v42_retention is not None),
        )
        ready_events = tuple(
            event
            for event in manager_events
        ...
        if (
            not v40_plus_repair
            and slot_v42_retention is None
            and ready_events
        ):
            _fail(
                "v40 cross-commit retention readiness escaped exact S037"
            )
        ...
        accepted = _accepted_evidence(
            ...
            allowed_schema_versions=(
                frozenset({1, 2})
                if v40_plus_repair or slot_v42_retention is not None
                else frozenset({1})
            ),
        )
        ...
        if v28_excluded_repair:
            validated_observation_contract = _validate_v28_excluded_repair_observation(
                cutoff_document,
                manifest=manifest,
                expected=expected,
                manager_events=manager_events,
            ...
            fault_active_phase_contract = (
                _v34_excluded_repair_fault_active_phase_contract(
                    manifest=manifest,
                    expected=expected,
                    runtime=runtime,
                    coverage_smoke=coverage_smoke,
        ...
        if hard_deadline_ns > _UINT64_MAX:
            _fail("shared hard deadline exceeds uint64")
        ...
        contribution_opportunities = (
            _fault_contribution_opportunities(
                replica_events,
                source_bound_proposal_witness_contract=(
                    source_bound_proposal_witness_contract
                    or SOURCE_BOUND_PROPOSAL_WITNESS_CONTRACT_V1
        ...
        if (
            ...
            selected = retention_validator(
                ...
                predecessor_epoch_digest=bundles[0].epoch_digest,
                selection_current_cutoff=_integer(
                    cycle1_snapshot.get("current_cutoff"),
                    "v42 cycle-1 selection current cutoff",
                    1,
                ),
                epoch2_selection_ns=hierarchy.epoch2_selection_ns,
                markers=markers,
                arm_markers=arm_markers,
                replica_events=raw_replica_events,
                epoch1_trees={tree.tree_id: tree for tree in bundles[0].trees},
                actor_origin_marker_window_id=expected_window,
            ...
            if (
                tuple(expected.responsive_degraded_actor_ids)
                != _V40_RESPONSIVE_DEGRADED_ACTORS
            ):
                _fail("v40 exact responsive-degraded actor cohort drifted")
            _validate_v40_cross_commit_retention_ready(
                manager_events=manager_events,
                accepted_epoch1=accepted.get(
                    (1, bundles[0].epoch_digest),
                    (),
                ...
                selection_current_cutoff=_integer(
                    cycle1_snapshot.get("current_cutoff"),
                    "v40 cycle-1 selection current cutoff",
                    1,
                ),
                epoch2_selection_ns=hierarchy.epoch2_selection_ns,
                markers=markers,
                ...
                actor_origin_marker_window_id=(
                    expected_window
                    if exact_v41_plus_repair
                    else _TIERED_OMISSION_WINDOW_V2
                ),
                manifest_id=manifest.manifest_id,
            )
