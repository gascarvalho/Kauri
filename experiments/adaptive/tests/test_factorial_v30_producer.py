...
def test_v30_six_identities_are_exact_frozen_values() -> None:
    assert manifest_module.FROZEN_MANIFEST_ID == "shape-placement-factorial-v30"
    assert (
...
def test_v30_is_default_and_v29_is_validation_only(
    capsys: pytest.CaptureFixture[str],
) -> None:
    assert cli.DEFAULT_MANIFEST == V30_MANIFEST
