...
def test_v36_identities_are_explicit_historical_aliases_and_v37_is_frozen() -> None:
    assert (
    ...
    assert manifest_module.FROZEN_MANIFEST_ID == "shape-placement-factorial-v37"
    assert (
...
def test_v37_is_default_and_v36_is_validation_only(
    capsys: pytest.CaptureFixture[str],
) -> None:
    assert cli.DEFAULT_MANIFEST == V37_MANIFEST
